...
use iris3d_scene::{BufferMeta, DataStore, HeldMeta, Parents, Placement};
use iris3d_scene::{DataArray, SceneObject};
...
/// anyway; it asks through [`SceneCommand`](iris3d_scene::SceneCommand).
///
...
pub struct Gathered {
    ...
    /// takes — see [`ParamKind::accepts`](iris3d_model::ParamKind).
