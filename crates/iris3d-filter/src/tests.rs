...
use iris3d_scene::registry::apply_actor_params;
...
fn app() -> App {
    ...
    app.init_asset::<DataArray>()
        ...
        .init_resource::<iris3d_scene::registry::ActorRegistry>()
...
mod commands {
    ...
    use iris3d_scene::registry::ActorRegistry;
    use iris3d_scene::{CommandBus, DataStore, SceneCommand, SceneError};
    ...
    fn app() -> App {
        ...
        app.add_systems(
            Update,
            (
                iris3d_scene::apply_scene_commands,
                crate::wire::apply_filter_commands,
            )
                .chain(),
        );
        app
