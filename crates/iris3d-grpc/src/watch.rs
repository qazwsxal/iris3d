...
//!
//! Commands travel ECS-wards over [`CommandBus`](iris3d_scene::CommandBus), a crossbeam
...
//!
//! Each stream holds its own [`Subscribe`](crate::proto::Subscribe) and drops what it did not ask for.
...
pub fn report_picks(
    ...
    events: Res<Events>,
    ids: Query<&iris3d_core::counter::UniqueID>,
