...
use iris3d_filter::{FilterKindSummary, FilterSummary, OutputKind};
use iris3d_model::{ParamKind, ParamMap, ParamSpec, ParamValue, SceneError};
use iris3d_scene::{
    ActorSummary, BufferMeta, DataSummary, Dtype, HeldMeta, KindSummary, NamedBuffer,
    ObjectSummary, SceneCommand,
};
    ...
    params
        ...
        .map(|(key, value)| {
            let value = match value {
                ...
                ParamValue::Unset => Value::Unset(crate::proto::Unset {}),
            };
