...
use iris3d_filter::colormap::ColorMap;
use iris3d_model::{Bindings, ParamKind, ParamSpec, float, text, vector};
use iris3d_model::{uvec3 as param_uvec3, vec3 as param_vec3};
...
fn pinned(params: &iris3d_model::ParamMap) -> Option<(f32, f32)> {
...
const PARAMS: &[ParamSpec] = &[
    ...
    ParamSpec {
        ...
        kind: ParamKind::Choice {
            options: iris3d_filter::colormap::MAPS,
            default: "viridis",
        },
    },
