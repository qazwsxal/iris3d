...
//
// There was a Rust twin of this function with tests on it; it went when the
// analysis code was stripped, and is in git history if the numbers below need
// re-checking. What they said is not encouraging: four power moments
