...
[`app/src/draw/default/`](../app/src/draw/default/) rather than above it.

[`draw/default/points.rs`](../app/src/draw/default/points.rs) is the smallest
complete example.
...
Shared specs live in [`draw/mod.rs`](../app/src/draw/mod.rs) — `crate::draw::TINT`
...
Add the module to [`draw/default/mod.rs`](../app/src/draw/default/mod.rs), call
...
[`draw::Dirty`](../app/src/draw/mod.rs) grades invalidation rather than treating
...
[`points.rs`](../app/src/draw/default/points.rs). Bevy resolves a filesystem
...
- Register the **real** `register` in the test app rather than a stand-in, so the
  ...
  [`points.rs`](../app/src/draw/default/points.rs).
- Add the kind to [`draw/smoke.rs`](../app/src/draw/smoke.rs), which builds a
