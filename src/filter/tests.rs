...
use crate::data::array::BufferMeta;
...
mod commands {
    ...
    use crate::data::array::{BufferMeta, NamedBuffer};
    use crate::model::SceneError;
    use crate::redraw::KeepAwake;
    use crate::scene::registry::ActorRegistry;
    use crate::scene::{CommandBus, DataStore, SceneCommand};
    ...
    fn add_filter(
        ...
        params.insert("values".to_string(), crate::model::ParamValue::Data(bound));
    ...
    fn a_filter_cannot_be_made_to_read_its_own_output() {
        ...
        params.insert(
            "values".to_string(),
            crate::model::ParamValue::Data(own_output),
        );
    ...
    fn a_cycle_through_another_filter_is_refused() {
        ...
        params.insert(
            "values".to_string(),
            crate::model::ParamValue::Data(second.outputs[0].1),
        );
        let mut set = send_filter(&app, |reply| FilterCommand::Set {
            id: first.id,
            params,
