...
///
/// The mirror of [`ParamKind`](crate::model::ParamKind) on the way in,
...
pub enum OutputKind {
    ...
    /// [`GeometryMeta`](crate::data::array::GeometryMeta) afterwards rather than
...
impl FilterKind {
    ...
    /// See [`crate::model::normalise`], which a filter kind and an actor kind
    /// share.
    pub fn normalise(&self, given: &ParamMap) -> ParamMap {
        crate::model::normalise(self.params, given)
    }
}
...
pub(crate) fn describe(name: &str, mesh: &Mesh) -> crate::data::array::GeometryMeta {
    crate::data::array::GeometryMeta {
        name: name.to_string(),
