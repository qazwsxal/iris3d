...
use crate::data::array::{Dtype, Held};
...
pub enum ParamValue {
    ...
    Vector(Vec<f64>),
    /// An uploaded array, by the handle [`DataStore`](crate::data::DataStore) knows it
    /// by.
    ///
...
pub enum ParamKind {
    ...
    /// [`GeometryMeta`](crate::data::array::GeometryMeta), and a kind reads it rather
...
impl ParamKind {
    ...
    /// checking a binding needs the [`DataStore`](crate::data::DataStore) to look up
