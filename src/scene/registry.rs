...
use crate::model::{Bindings, ParamMap, ParamSpec, data};
...
impl ActorKind {
    ...
    /// See [`crate::model::normalise`], which an actor kind and a filter kind
    /// share.
...
mod tests {
    ...
    use crate::data::array::{BufferMeta, Dtype, Held};
    use crate::model::{ParamKind, ParamValue, flag, float, uvec3};
    ...
    fn geometry() -> crate::data::array::GeometryMeta {
