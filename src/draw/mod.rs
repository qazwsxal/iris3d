...
use crate::model::{Bindings, ParamKind, ParamMap, ParamSpec};
...
pub(crate) fn tint(params: &ParamMap, id: &str, fallback: Vec3) -> Vec3 {
    let srgb = crate::model::vec3(params, id, fallback);
...
mod tests {
    ...
    use crate::scene::registry::ActorParams;
    ...
    const SPECS: &[crate::model::ParamSpec] = &[
